...
#ifndef PIO_UNIT_TESTING
// T-Deck launcher mesh kill-switch: apply any pending on/off request from the UI task on
// this (main) thread — the safe radio context. Defined in src/TDeckMeshSwitch.cpp.
