...
*/
/* T-Deck: force 32-bit mode here (not just via -D) so EVERY translation unit —
   the library and the app-engine bridges — agrees on the ABI, and so C++ units
   don't need LLONG_MAX visible to define LUA_INTEGER. */
#define LUA_32BITS 1
